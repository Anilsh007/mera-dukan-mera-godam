export const dugamSEOData = {
  ...
  primaryKeywords: [
    ...
    "Quick purchase software",
    "Quick sales software",
    "Stock tracker software",
    "Mobile and desktop sync software",
  ...
  businessKeywords: [
    ...
    "MSME inventory management software",
  ...
  pricingKeywords: [
    "billing software under 999 rupees",
    "inventory software under 999 rupees",
    "99 rupees per month billing software",
    "2.74 rupees per day inventory software",
    "very cheap billing software for small shop",
    "billing software for big and small shop",
    "billing software for all types of shops",
