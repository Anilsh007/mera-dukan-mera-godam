  ...
  return (
    <div className="relative isolate overflow-hidden bg-[var(--bg-primary)] text-[var(--text-primary)]">
      ...
      <div className="lg:px-30 px-5">
        <section className="grid min-h-[calc(100vh-3.5rem)] items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] py-16">
          <div>
            <h1 className="text-balance text-4xl font-black leading-[1.05] tracking-[-0.04em] text-[var(--text-primary)] sm:text-5xl lg:text-7xl">
