...
const toneClassName: Record<StatusBadgeTone, string> = {
  ...
  success: "border-emerald-300/70 bg-emerald-500/10 text-emerald-700 dark:border-emerald-500/40 dark:text-emerald-200",
  warning: "border-amber-300/80 bg-amber-500/10 text-amber-800 dark:border-amber-500/40 dark:text-amber-200",
  danger: "border-rose-300/80 bg-rose-500/10 text-rose-700 dark:border-rose-500/40 dark:text-rose-200",
